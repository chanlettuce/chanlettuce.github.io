...
const skils: {
  ...
  { name: 'JavaScript', rate: 4, category: '言語' },
  {
    ...
    rate: 4,
    category: '言語',
    remarks: 'マルチプロセスのテストは厳しい',
  },
  { name: 'Node.js', rate: 3, category: 'その他' },
  { name: 'PHP', rate: 2, category: '言語' },
  { name: 'Python', rate: 2, category: '言語' },
  { name: 'C#', rate: 2, category: '言語' },
  ...
  { name: 'Express', rate: 3, category: 'FW/ライブラリ' },
  {
    ...
    rate: 3,
    category: 'FW/ライブラリ',
    remarks: 'SSGの場合はGatsbyより好き',
  },
  {
    name: 'Gatsby',
    rate: 3,
    category: 'FW/ライブラリ',
    remarks: 'プラグインの数が多く、理解しきれていない部分はある',
  },
  { name: 'Vue.js', rate: 1, category: 'FW/ライブラリ' },
  {
    ...
    rate: 1,
    category: 'FW/ライブラリ',
    remarks: '軽量アプリケーションにはこれを使っていきたい',
  },
